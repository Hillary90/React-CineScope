...
export default function AiRecommendation() {
  ...
  const [inputs, setInputs] = useState(initialState); // create an input and it going to update the input, and passing intialState from the user based on the question to usestate
  ...
  return(
    ...
    >
      <h2 
       ...
       font-black mb-8 text-center tracking-tight 
       drop-shadow-lg"
      >
      ...
      <div className="w-full flex items-center mb-8">
          <div className=" flex-1 bg-gray-600 rounded-full overflow-hidden h-2">
           <div className="h-full bg-gray-600 transition-all duration-300" ></div>
          </div>         
      </div>
